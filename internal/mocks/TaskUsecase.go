...
func (_m *TaskUsecase) Create(task *domain.Task) (*domain.Task, error) {
	ret := _m.Called(task)
...
func (_m *TaskUsecase) Delete(id int64, userID int64) error {
...
// GetAll provides a mock function with given fields: userID, page, limit
func (_m *TaskUsecase) GetAll(userID int64, page int, limit int) ([]domain.Task, error) {
...
func (_m *TaskUsecase) GetByID(id int64, userID int64) (*domain.Task, error) {
	ret := _m.Called(id, userID)
